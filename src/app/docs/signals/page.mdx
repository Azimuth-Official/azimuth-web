export const metadata = {
  ...
  description: "LTE, 5G, digital television, FM radio, and LEO satellite signals used by Azimuth for positioning.",
  alternates: { canonical: "https://azimuth.day/docs/signals" },
  openGraph: {
    title: "Signal Targets",
    description: "LTE, 5G, digital television, FM radio, and LEO satellite signals used by Azimuth for positioning.",
    url: "https://azimuth.day/docs/signals",
  },
  twitter: {
    title: "Signal Targets",
    description: "LTE, 5G, digital television, FM radio, and LEO satellite signals used by Azimuth for positioning.",

...
SDR receivers deployed by node operators passively capture timing information from signals of opportunity — LTE/5G cell tower reference signals, digital television pilots, and FM radio subcarriers. Each node extracts precise timestamps from these signals without transmitting anything.

Nodes range from simple USB SDR dongles connected to consumer hardware (Tier 1) to dedicated units with GPS-disciplined oscillators and outdoor antennas (Tier 2) to multi-channel coherent arrays capable of both time and angle measurements (Tier 3).

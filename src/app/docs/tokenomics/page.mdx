export const metadata = {
  title: "Tokenomics",
  description: "Token utility, node operator rewards, query payments, and governance for the Azimuth network.",
  alternates: { canonical: "https://azimuth.day/docs/tokenomics" },
  openGraph: {
    title: "Tokenomics",
    description: "Token utility, node operator rewards, query payments, and governance for the Azimuth network.",
    url: "https://azimuth.day/docs/tokenomics",
  },
  twitter: {
    title: "Tokenomics",
    description: "Token utility, node operator rewards, query payments, and governance for the Azimuth network.",

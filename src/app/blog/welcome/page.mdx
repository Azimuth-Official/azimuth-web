export const metadata = {
  ...
  description: "Announcing Azimuth: a decentralized alternative to GPS built on signals of opportunity.",
  alternates: { canonical: "https://azimuth.day/blog/welcome" },
  openGraph: {
    title: "Introducing Azimuth",
    description: "Announcing Azimuth: a decentralized alternative to GPS built on signals of opportunity.",
    url: "https://azimuth.day/blog/welcome",
  },
  twitter: {
    title: "Introducing Azimuth",
    description: "Announcing Azimuth: a decentralized alternative to GPS built on signals of opportunity.",
